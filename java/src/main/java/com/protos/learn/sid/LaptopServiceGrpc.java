...
@javax.annotation.Generated(
    ...
    comments = "Source: test_laptop_service.proto")
public final class LaptopServiceGrpc {

  private LaptopServiceGrpc() {}

  public static final String SERVICE_NAME = "com.protos.learn.LaptopService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.protos.learn.sid.CreateLaptopRequest,
      com.protos.learn.sid.CreateLaptopResponse> getCreateLaptopMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateLaptop",
      requestType = com.protos.learn.sid.CreateLaptopRequest.class,
      responseType = com.protos.learn.sid.CreateLaptopResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.protos.learn.sid.CreateLaptopRequest,
      com.protos.learn.sid.CreateLaptopResponse> getCreateLaptopMethod() {
    io.grpc.MethodDescriptor<com.protos.learn.sid.CreateLaptopRequest, com.protos.learn.sid.CreateLaptopResponse> getCreateLaptopMethod;
      ...
      synchronized (LaptopServiceGrpc.class) {
        if ((getCreateLaptopMethod = LaptopServiceGrpc.getCreateLaptopMethod) == null) {
          LaptopServiceGrpc.getCreateLaptopMethod = getCreateLaptopMethod =
              io.grpc.MethodDescriptor.<com.protos.learn.sid.CreateLaptopRequest, com.protos.learn.sid.CreateLaptopResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateLaptop"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.protos.learn.sid.CreateLaptopRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.protos.learn.sid.CreateLaptopResponse.getDefaultInstance()))
  ...
  public static abstract class LaptopServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void createLaptop(com.protos.learn.sid.CreateLaptopRequest request,
        io.grpc.stub.StreamObserver<com.protos.learn.sid.CreateLaptopResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.protos.learn.sid.CreateLaptopRequest,
                com.protos.learn.sid.CreateLaptopResponse>(
  ...
  public static final class LaptopServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<LaptopServiceBlockingStub> {
    ...
    /**
     */
    public com.protos.learn.sid.CreateLaptopResponse createLaptop(com.protos.learn.sid.CreateLaptopRequest request) {
  ...
  public static final class LaptopServiceFutureStub extends io.grpc.stub.AbstractFutureStub<LaptopServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.protos.learn.sid.CreateLaptopResponse> createLaptop(
        com.protos.learn.sid.CreateLaptopRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_LAPTOP:
          serviceImpl.createLaptop((com.protos.learn.sid.CreateLaptopRequest) request,
              (io.grpc.stub.StreamObserver<com.protos.learn.sid.CreateLaptopResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class LaptopServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.protos.learn.sid.TestLaptopService.getDescriptor();
    }
